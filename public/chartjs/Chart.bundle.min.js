...
!function (t) {
    ...
    return function e(t, n, i) {
        ...
        1: [function (t, e, n) {
            ...
            function i(t) {
                var e, n, i, a = t[0] / 255, r = t[1] / 255, o = t[2] / 255, s = Math.min(a, r, o), l = Math.max(a, r, o), d = l - s;
            ...
            function a(t) {
                var e, n, i, a = t[0], r = t[1], o = t[2], s = Math.min(a, r, o), l = Math.max(a, r, o), d = l - s;
            ...
            function u(t) {
                var e, n, i, a = d(t), r = a[0], o = a[1], s = a[2];
            ...
            !function (e, a) {
                ...
                function h(t) {
                    if (null == t._isValid) {
                        var e = c(t), n = di.call(e.parsedDateParts, function (t) {
                            return null != t
                        });
                ...
                function ot(t, e, n) {
                    ...
                    if (!this._monthsParse)for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], i = 0; 12 > i; ++i)r = d([2e3, i]), this._shortMonthsParse[i] = this.monthsShort(r, "").toLocaleLowerCase(), this._longMonthsParse[i] = this.months(r, "").toLocaleLowerCase();
                ...
                function st(t, e, n) {
                    ...
                    for (this._monthsParse || (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = []), i = 0; 12 > i; i++) {
                        if (a = d([2e3, i]), n && !this._longMonthsParse[i] && (this._longMonthsParse[i] = new RegExp("^" + this.months(a, "").replace(".", "") + "$", "i"), this._shortMonthsParse[i] = new RegExp("^" + this.monthsShort(a, "").replace(".", "") + "$", "i")), n || this._monthsParse[i] || (r = "^" + this.months(a, "") + "|^" + this.monthsShort(a, ""), this._monthsParse[i] = new RegExp(r.replace(".", ""), "i")), n && "MMMM" === e && this._longMonthsParse[i].test(t))return i;
                ...
                function ft() {
                    ...
                    var e, n, i = [], a = [], r = [];
                    for (e = 0; 12 > e; e++)n = d([2e3, e]), i.push(this.monthsShort(n, "")), a.push(this.months(n, "")), r.push(this.months(n, "")), r.push(this.monthsShort(n, ""));
                ...
                function wt(t, e, n, i, a) {
                    var r, o, s = (7 + n - i) % 7, l = _t(t, i, a), d = 1 + 7 * (e - 1) + s + l;
                    return 0 >= d ? (r = t - 1, o = yt(r) + d) : d > yt(t) ? (r = t + 1, o = d - yt(t)) : (r = t, o = d), {
                        year: r,
                        dayOfYear: o
                    }
                }
                ...
                function Ft(e) {
                    ...
                    e._a = [], c(e).empty = !0;
                    var n, i, a, r, o, s = "" + e._i, l = s.length, d = 0;
                    for (a = J(e._f, e._locale).match(bi) || [], n = 0; n < a.length; n++)r = a[n], i = (s.match(Q(r, e)) || [])[0], i && (o = s.substr(0, s.indexOf(i)), o.length > 0 && c(e).unusedInput.push(o), s = s.slice(s.indexOf(i) + i.length), d += i.length), ki[r] ? (i ? c(e).empty = !1 : c(e).unusedTokens.push(r), nt(r, i, e)) : e._strict && !i && c(e).unusedTokens.push(r);
                    c(e).charsLeftOver = l - d, s.length > 0 && c(e).unusedInput.push(s), c(e).bigHour === !0 && e._a[Ui] <= 12 && e._a[Ui] > 0 && (c(e).bigHour = void 0), c(e).parsedDateParts = e._a.slice(0), c(e).meridiem = e._meridiem, e._a[Ui] = At(e._locale, e._a[Ui], e._meridiem), Tt(e), gt(e)
                }
                ...
                function Nt(t) {
                    var e = B(t), n = e.year || 0, i = e.quarter || 0, a = e.month || 0, r = e.week || 0, o = e.day || 0, s = e.hour || 0, l = e.minute || 0, d = e.second || 0, u = e.millisecond || 0;
                    this._milliseconds = +u + 1e3 * d + 6e4 * l + 1e3 * s * 60 * 60, this._days = +o + 7 * r, this._months = +a + 3 * i + 12 * n, this._data = {}, this._locale = W(), this._bubble()
                }
                ...
                function ln(t, e, n) {
                    ...
                    for (this._weekdaysParse || (this._weekdaysParse = [], this._minWeekdaysParse = [], this._shortWeekdaysParse = [], this._fullWeekdaysParse = []), i = 0; 7 > i; i++) {
                        if (a = d([2e3, 1]).day(i), n && !this._fullWeekdaysParse[i] && (this._fullWeekdaysParse[i] = new RegExp("^" + this.weekdays(a, "").replace(".", ".?") + "$", "i"), this._shortWeekdaysParse[i] = new RegExp("^" + this.weekdaysShort(a, "").replace(".", ".?") + "$", "i"), this._minWeekdaysParse[i] = new RegExp("^" + this.weekdaysMin(a, "").replace(".", ".?") + "$", "i")), this._weekdaysParse[i] || (r = "^" + this.weekdays(a, "") + "|^" + this.weekdaysShort(a, "") + "|^" + this.weekdaysMin(a, ""), this._weekdaysParse[i] = new RegExp(r.replace(".", ""), "i")), n && "dddd" === e && this._fullWeekdaysParse[i].test(t))return i;
                ...
                function pn() {
                    ...
                    for (e = 0; 7 > e; e++)n = d([2e3, 1]).day(e), i = this.weekdaysMin(n, ""), a = this.weekdaysShort(n, ""), r = this.weekdays(n, ""), o.push(i), s.push(a), l.push(r), u.push(i), u.push(a), u.push(r);
                    for (o.sort(t), s.sort(t), l.sort(t), u.sort(t), e = 0; 7 > e; e++)s[e] = K(s[e]), l[e] = K(l[e]), u[e] = K(u[e]);
                ...
                function ai(t, e, n) {
                    var i = re(t).abs(), a = nr(i.as("s")), r = nr(i.as("m")), o = nr(i.as("h")), s = nr(i.as("d")), l = nr(i.as("M")), d = nr(i.as("y")), u = a < ir.s && ["s", a] || 1 >= r && ["m"] || r < ir.m && ["mm", r] || 1 >= o && ["h"] || o < ir.h && ["hh", o] || 1 >= s && ["d"] || s < ir.d && ["dd", s] || 1 >= l && ["M"] || l < ir.M && ["MM", l] || 1 >= d && ["y"] || ["yy", d];
                ...
                function si() {
                    ...
                    var o = n, s = r, l = a, d = e, u = t, c = i, h = this.asSeconds();
                ...
                var ui = t.momentProperties = [], ci = !1, hi = {};
                ...
                }), da = _("moment().max is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548", function () {
                    var t = Yt.apply(null, arguments);
                ...
                re.fn = Nt.prototype;
                var ga = ue(1, "add"), pa = ue(-1, "subtract");
            ...
            e.exports = function (t) {
                ...
                t.defaults.bar = {
                    ...
                    updateElement: function (t, n, i) {
                        var a = this, r = a.getMeta(), o = a.getScaleForId(r.xAxisID), s = a.getScaleForId(r.yAxisID), l = s.getBasePixel(), d = a.chart.options.elements.rectangle, u = t.custom || {}, c = a.getDataset();
                        e.extend(t, {
                            _xScale: o,
                            _yScale: s,
                    ...
                    calculateBarBase: function (t, e) {
                        ...
                        if (a.options.stacked) {
                            ...
                            if (0 > l)for (var d = 0; t > d; d++) {
                                var u = s[d], c = o.getDatasetMeta(d);
                                c.bar && c.yAxisID === a.id && o.isDatasetVisible(d) && (r += u.data[e] < 0 ? u.data[e] : 0)
                    ...
                    calculateBarY: function (t, e) {
                        ...
                        if (a.options.stacked) {
                            for (var o = 0, s = 0, l = 0; e > l; l++) {
                                ...
                                u.bar && u.yAxisID === a.id && n.chart.isDatasetVisible(l) && (d.data[t] < 0 ? s += d.data[t] || 0 : o += d.data[t] || 0)
                            }
                    ...
                    updateElement: function (t, n, i, a) {
                        var r = this, o = r.getMeta(), s = r.getScaleForId(o.xAxisID), l = r.getScaleForId(o.yAxisID), d = s.getBasePixel(), u = t.custom || {}, c = r.getDataset(), h = r.chart.options.elements.rectangle;
                        e.extend(t, {
                            _xScale: s,
                            _yScale: l,
                            ...
                            _index: n,
                            _model: {
                                x: i ? d : r.calculateBarX(n, r.index),
                                y: r.calculateBarY(n, r.index),
                                label: r.chart.data.labels[n],
                                datasetLabel: c.label,
                                base: i ? d : r.calculateBarBase(r.index, n),
                                height: r.calculateBarHeight(n),
                                backgroundColor: u.backgroundColor ? u.backgroundColor : e.getValueAtIndexOrDefault(c.backgroundColor, n, h.backgroundColor),
                                borderSkipped: u.borderSkipped ? u.borderSkipped : h.borderSkipped,
                                borderColor: u.borderColor ? u.borderColor : e.getValueAtIndexOrDefault(c.borderColor, n, h.borderColor),
                                borderWidth: u.borderWidth ? u.borderWidth : e.getValueAtIndexOrDefault(c.borderWidth, n, h.borderWidth)
                            },
                            draw: function () {
                                function t(t) {
                                    return l[(u + t) % 4]
                                ...
                                var l = [[n.base, r], [n.base, a], [o, a], [o, r]], d = ["bottom", "left", "top", "right"], u = d.indexOf(n.borderSkipped, 0);
                        ...
                        if (a.options.stacked) {
                            ...
                            if (0 > o)for (var s = 0; t > s; s++) {
                                var l = n.chart.data.datasets[s], d = n.chart.getDatasetMeta(s);
                                d.bar && d.xAxisID === a.id && n.chart.isDatasetVisible(s) && (r += l.data[e] < 0 ? l.data[e] : 0)
                            } else for (var u = 0; t > u; u++) {
                                var c = n.chart.data.datasets[u], h = n.chart.getDatasetMeta(u);
                                h.bar && h.xAxisID === a.id && n.chart.isDatasetVisible(u) && (r += c.data[e] > 0 ? c.data[e] : 0)
                            }
                            return a.getPixelForValue(r)
                        }
                        return a.getBasePixel()
                        ...
                        if (a.options.stacked) {
                            for (var o = 0, s = 0, l = 0; e > l; l++) {
                                var d = n.chart.data.datasets[l], u = n.chart.getDatasetMeta(l);
                                u.bar && u.xAxisID === a.id && n.chart.isDatasetVisible(l) && (d.data[t] < 0 ? s += d.data[t] || 0 : o += d.data[t] || 0)
                            }
                            return 0 > r ? a.getPixelForValue(s + r) : a.getPixelForValue(o + r)
                        }
                        return a.getPixelForValue(r)
            ...
            e.exports = function (t) {
                ...
                t.defaults.bubble = {
                    ...
                    updateElement: function (n, i, a) {
                        var r = this, o = r.getMeta(), s = r.getScaleForId(o.xAxisID), l = r.getScaleForId(o.yAxisID), d = n.custom || {}, u = r.getDataset(), c = u.data[i], h = r.chart.options.elements.point, f = r.index;
                        e.extend(n, {
                            _xScale: s,
                            _yScale: l,
                            _datasetIndex: f,
            ...
            e.exports = function (t) {
                ...
                n.doughnut = {
                    ...
                    update: function (t) {
                        var n = this, i = n.chart, a = i.chartArea, r = i.options, o = r.elements.arc, s = a.right - a.left - o.borderWidth, l = a.bottom - a.top - o.borderWidth, d = Math.min(s, l), u = {
                            x: 0,
                            y: 0
                        ...
                        if (f < 2 * Math.PI) {
                            ...
                            d = Math.min(s / M.width, l / M.height), u = {x: (S.x + w.x) * -.5, y: (S.y + w.y) * -.5}
                        }
            ...
            e.exports = function (t) {
                ...
                t.defaults.line = {
                    ...
                    update: function (t) {
                        var i, a, r, o = this, s = o.getMeta(), l = s.dataset, d = s.data || [], u = o.chart.options, c = u.elements.line, h = o.getScaleForId(s.yAxisID), f = o.getDataset(), g = e(f, u);
                    ...
                    updateElement: function (t, e, i) {
                        var a, r, o = this, s = o.getMeta(), l = t.custom || {}, d = o.getDataset(), u = o.index, c = d.data[e], h = o.getScaleForId(s.yAxisID), f = o.getScaleForId(s.xAxisID), g = o.chart.options.elements.point;
                        void 0 !== d.radius && void 0 === d.pointRadius && (d.pointRadius = d.radius), void 0 !== d.hitRadius && void 0 === d.pointHitRadius && (d.pointHitRadius = d.hitRadius), a = f.getPixelForValue(c, e, u, o.chart.isCombo), r = i ? h.getBasePixel() : o.calculatePointY(c, e, u, o.chart.isCombo), t._xScale = f, t._yScale = h, t._datasetIndex = u, t._index = e, t._model = {
                            x: a,
                            y: r,
                    ...
                    calculatePointY: function (t, e, n, i) {
                        var a, r, o, s = this, l = s.chart, d = s.getMeta(), u = s.getScaleForId(d.yAxisID), c = 0, h = 0;
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    updateElement: function (t, n, i) {
                        for (var a = this, r = a.chart, o = r.chartArea, s = a.getDataset(), l = r.options, d = l.animation, u = (l.elements.arc, t.custom || {}, r.scale), c = e.getValueAtIndexOrDefault, h = r.data.labels, f = a.calculateCircumference(s.data[n]), g = (o.left + o.right) / 2, p = (o.top + o.bottom) / 2, m = 0, v = a.getMeta(), b = 0; n > b; ++b)isNaN(s.data[b]) || v.data[b].hidden || ++m;
                        var y = -.5 * Math.PI, x = t.hidden ? 0 : u.getDistanceFromCenterForValue(s.data[n]), k = y + f * m, _ = k + (t.hidden ? 0 : f), w = d.animateScale ? 0 : u.getDistanceFromCenterForValue(s.data[n]);
                        e.extend(t, {
                            _datasetIndex: a.index,
                            _index: n,
                            _scale: u,
                            _model: {
                                ...
                                innerRadius: 0,
                                outerRadius: i ? w : x,
                                startAngle: i && d.animateRotate ? y : k,
                                endAngle: i && d.animateRotate ? y : _,
                                label: c(h, n, h[n])
                            }
            ...
            e.exports = function (t) {
                ...
                t.defaults.radar = {
                    ...
                    update: function (t) {
                        var n = this, i = n.getMeta(), a = i.dataset, r = i.data, o = a.custom || {}, s = n.getDataset(), l = n.chart.options.elements.line, d = n.chart.scale;
                    ...
                    updateElement: function (t, n, i) {
                        var a = this, r = t.custom || {}, o = a.getDataset(), s = a.chart.scale, l = a.chart.options.elements.point, d = s.getPointPositionForValue(n, o.data[n]);
                        e.extend(t, {
                            _datasetIndex: a.index,
                            _index: n,
                            _scale: s,
            ...
            e.exports = function (t) {
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (n) {
                    ...
                    initialize: function () {
                        ...
                        var i = this, a = i.chart, r = a.canvas, o = e.getMaximumWidth(r), s = a.aspectRatio, l = i.options.maintainAspectRatio && isNaN(s) === !1 && isFinite(s) && 0 !== s ? o / s : e.getMaximumHeight(r), d = a.width !== o || a.height !== l;
                        if (!d)return i;
                        ...
                        i.scales && (r = r.concat((i.scales.xAxes || []).map(function (t) {
                            ...
                            if (l) {
                                var d = new l({id: o.id, options: o, ctx: n.chart.ctx, chart: n});
                                a[d.id] = d, i.isDefault && (n.scale = d)
                            }
            ...
            e.exports = function (t) {
                ...
                function a(t, i, a) {
                    var r = document.defaultView, o = t.parentNode, s = r.getComputedStyle(t)[i], l = r.getComputedStyle(o)[i], d = n(s), u = n(l), c = Number.POSITIVE_INFINITY;
                ...
                r.each = function (t, e, n, i) {
                    ...
                    var a = t.skip ? e : t, r = e, o = n.skip ? e : n, s = Math.sqrt(Math.pow(r.x - a.x, 2) + Math.pow(r.y - a.y, 2)), l = Math.sqrt(Math.pow(o.x - r.x, 2) + Math.pow(o.y - r.y, 2)), d = s / (s + l), u = l / (s + l);
                ...
                r.requestAnimFrame = function () {
                    ...
                    var d = parseFloat(r.getStyle(o, "padding-left")), u = parseFloat(r.getStyle(o, "padding-top")), c = parseFloat(r.getStyle(o, "padding-right")), h = parseFloat(r.getStyle(o, "padding-bottom")), f = s.right - s.left - d - c, g = s.bottom - s.top - u - h;
                ...
                t.layoutService = {
                    defaults: {}, addBox: function (t, e) {
                        ...
                        if (t) {
                            ...
                            var p = n - 2 * l, m = i - 2 * d, v = p / 2, b = m / 2, y = (n - v) / (u.length + c.length), x = (i - b) / (h.length + f.length), k = p, _ = m, w = [];
                            ...
                            e.each(u.concat(c), r), e.each(u, function (t) {
                                ...
                                C += t.height
                            }), e.each(u.concat(c), o), S = l, M = l, D = d, C = d, e.each(u, function (t) {
                                S += t.width
                            }), e.each(c, function (t) {
                                M += t.width
                            }), e.each(h, function (t) {
                            ...
                            var F = l, A = d;
                            e.each(u.concat(h), s), F += k, A += _, e.each(c, s), e.each(f, s), t.chartArea = {
                                left: S,
                                top: D,
                                right: S + k,
                                bottom: D + _
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.legend = {
                    ...
                    initialize: function (t) {
                        ...
                        var n = this, i = n.options, a = i.labels, r = i.display, o = n.ctx, s = t.defaults.global, l = e.getValueOrDefault, d = l(a.fontSize, s.defaultFontSize), u = l(a.fontStyle, s.defaultFontStyle), c = l(a.fontFamily, s.defaultFontFamily), h = e.fontString(d, u, c), f = n.legendHitBoxes = [], g = n.minSize, p = n.isHorizontal();
                        if (p ? (g.width = n.maxWidth, g.height = r ? 10 : 0) : (g.width = r ? 10 : 0, g.height = n.maxHeight), r)if (o.font = h, p) {
                            ...
                            o.textAlign = "left", o.textBaseline = "top", e.each(n.legendItems, function (t, e) {
                                var i = a.boxWidth + d / 2 + o.measureText(t.text).width;
                                m[m.length - 1] + i + a.padding >= n.width && (v += d + a.padding, m[m.length] = n.left), f[e] = {
                                    left: 0,
                                    top: 0,
                                    width: i,
                                    height: d
                            ...
                            var b = a.padding, y = n.columnWidths = [], x = a.padding, k = 0, _ = 0, w = d + b;
                            e.each(n.legendItems, function (t, e) {
                                var n = a.boxWidth + d / 2 + o.measureText(t.text).width;
                        ...
                        if (i.display) {
                            var d, u = n.ctx, c = e.getValueOrDefault, h = c(a.fontColor, r.defaultFontColor), f = c(a.fontSize, r.defaultFontSize), g = c(a.fontStyle, r.defaultFontStyle), p = c(a.fontFamily, r.defaultFontFamily), m = e.fontString(f, g, p);
                            ...
                            var v = a.boxWidth, b = n.legendHitBoxes, y = function (t, e, n) {
                                u.save(), u.fillStyle = c(n.fillStyle, r.defaultColor), u.lineCap = c(n.lineCap, o.borderCapStyle), u.lineDashOffset = c(n.lineDashOffset, o.borderDashOffset), u.lineJoin = c(n.lineJoin, o.borderJoinStyle), u.lineWidth = c(n.lineWidth, o.borderWidth), u.strokeStyle = c(n.strokeStyle, r.defaultColor), u.setLineDash && u.setLineDash(c(n.lineDash, o.borderDash)), u.strokeRect(t, e, v, f), u.fillRect(t, e, v, f), u.restore()
                            }, x = function (t, e, n, i) {
                            ...
                            var _ = f + a.padding;
                            e.each(n.legendItems, function (t, e) {
                                var i = u.measureText(t.text).width, r = v + f / 2 + i, o = d.x, c = d.y;
                                k ? o + r >= s && (c = d.y += f + a.padding, d.line++, o = d.x = n.left + (s - l[d.line]) / 2) : c + _ > n.bottom && (o = d.x = o + n.columnWidths[d.line] + a.padding, c = d.y = n.top, d.line++), y(o, c, t), b[e].left = o, b[e].top = c, x(o, c, t, i), k ? d.x += r + a.padding : d.y += _
                            })
                        }
            ...
            e.exports = function (t) {
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function () {
                        var n = this, i = n.ctx, a = t.defaults.global, r = n.options.ticks, o = e.getValueOrDefault(r.fontSize, a.defaultFontSize), s = e.getValueOrDefault(r.fontStyle, a.defaultFontStyle), l = e.getValueOrDefault(r.fontFamily, a.defaultFontFamily), d = e.fontString(o, s, l);
                        i.font = d;
                        var u, c = i.measureText(n.ticks[0]).width, h = i.measureText(n.ticks[n.ticks.length - 1]).width;
                    ...
                    fit: function () {
                        var n = this, i = n.minSize = {
                            width: 0,
                            height: 0
                        }, a = n.options, r = t.defaults.global, o = a.ticks, s = a.scaleLabel, l = a.display, d = n.isHorizontal(), u = e.getValueOrDefault(o.fontSize, r.defaultFontSize), c = e.getValueOrDefault(o.fontStyle, r.defaultFontStyle), h = e.getValueOrDefault(o.fontFamily, r.defaultFontFamily), f = e.fontString(u, c, h), g = e.getValueOrDefault(s.fontSize, r.defaultFontSize), p = e.getValueOrDefault(s.fontStyle, r.defaultFontStyle), m = e.getValueOrDefault(s.fontFamily, r.defaultFontFamily), v = (e.fontString(g, p, m), a.gridLines.tickMarkLength);
                        if (d ? i.width = n.isFullWidth() ? n.maxWidth - n.margins.left - n.margins.right : n.maxWidth : i.width = l ? v : 0, d ? i.height = l ? v : 0 : i.height = n.maxHeight, s.display && l && (d ? i.height += 1.5 * g : i.width += 1.5 * g), o.display && l) {
                            n.longestTextCache || (n.longestTextCache = {});
                            var b = e.longestText(n.ctx, f, n.ticks, n.longestTextCache), y = e.numberOfLabelLines(n.ticks), x = .5 * u;
                            if (d) {
                                n.longestLabelWidth = b;
                                var k = Math.sin(e.toRadians(n.labelRotation)) * n.longestLabelWidth + u * y + x * y;
                                ...
                                n.paddingLeft = 0 !== n.labelRotation ? S * _ + 3 : _ / 2 + 3, n.paddingRight = 0 !== n.labelRotation ? M * (u / 2) + 3 : w / 2 + 3
                            } else {
                                var D = n.maxWidth - i.width, C = o.mirror;
                                C ? b = 0 : b += n.options.ticks.padding, D > b ? i.width += b : i.width = n.maxWidth, n.paddingTop = u / 2, n.paddingBottom = u / 2
                            }
                        }
                    ...
                    draw: function (n) {
                        ...
                        if (a.display) {
                            var r, o, s = i.ctx, l = t.defaults.global, d = a.ticks, u = a.gridLines, c = a.scaleLabel, h = 0 !== i.labelRotation, f = d.autoSkip, g = i.isHorizontal();
                            ...
                            var P = [];
                            if (g) {
                                if (r = !1, h && (T /= 2), (T + d.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) && (r = 1 + Math.floor((T + d.autoSkipPadding) * i.ticks.length / (i.width - (i.paddingLeft + i.paddingRight)))), o && i.ticks.length > o)for (; !r || i.ticks.length / (r || 1) > o;)r || (r = 1), r += 1;
                                f || (r = !1)
                            }
                                    ...
                                    if (void 0 !== t && null !== t) {
                                        ...
                                        if ((!l || s) && void 0 !== t && null !== t) {
                                            ...
                                            if (g) {
                                                ...
                                                S = i.getPixelForTick(o, u.offsetGridLines) + d.labelOffset, M = h ? i.top + 12 : "top" === a.position ? i.bottom - x : i.top + x, p = v = y = _ = R, m = I, b = O, k = n.top, w = n.bottom
                                            } else {
                                                "left" === a.position ? d.mirror ? (S = i.right + d.padding, C = "left") : (S = i.right - d.padding, C = "right") : d.mirror ? (S = i.left - d.padding, C = "right") : (S = i.left + d.padding, C = "left");
                                                var W = i.getPixelForTick(o);
                                                W += e.aliasPixel(c), M = i.getPixelForTick(o, u.offsetGridLines), p = F, v = A, y = n.left, _ = n.right, m = b = k = w = W
                                            }
                                            P.push({
                                                tx1: p,
                                                ty1: m,
            ...
            e.exports = function (t) {
                ...
                t.Title = t.Element.extend({
                    ...
                    draw: function () {
                        ...
                        if (r.display) {
                            var s, l, d = a(r.fontSize, o.defaultFontSize), u = a(r.fontStyle, o.defaultFontStyle), c = a(r.fontFamily, o.defaultFontFamily), h = e.fontString(d, u, c), f = 0, g = n.top, p = n.left, m = n.bottom, v = n.right;
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.tooltips = {
                    ...
                    initialize: function () {
                        ...
                        var e, r, o = this, s = o._options, l = o._model, d = o._active, u = o._data, c = o._chartInstance;
                        if (d.length) {
                            l.opacity = 1;
                            var h = [], f = n(d), g = [];
                        ...
                        var o = t.title.length, s = t.footer.length, l = t.titleFontSize, d = t.bodyFontSize, u = t.footerFontSize;
                        ...
                        var r, o, s, l, d, u = (a.left + a.right) / 2, c = (a.top + a.bottom) / 2;
                        ...
                        var n = {
                            x: t.x,
                            y: t.y
                        }, i = t.caretSize, a = t.caretPadding, r = t.cornerRadius, o = t.xAlign, s = t.yAlign, l = i + a, d = r + a;
                        ...
                        var r, o, s, l, d, u, c = this._view, h = this._chart.ctx, f = c.caretSize, g = c.cornerRadius, p = c.xAlign, m = c.yAlign, v = t.x, b = t.y, y = e.width, x = e.height;
                        "center" === m ? ("left" === p ? (r = v, o = r - f, s = r) : (r = v + y, o = r + f, s = r), d = b + x / 2, l = d - f, u = d + f) : ("left" === p ? (r = v + g, o = r + f, s = o + f) : "right" === p ? (r = v + y - g, o = r - f, s = o - f) : (o = v + y / 2, r = o - f, s = o + f), "top" === m ? (l = b, d = l - f, u = l) : (l = b + x, d = l + f, u = l));
                        var k = a.color(c.backgroundColor);
                        h.fillStyle = k.alpha(n * k.alpha()).rgbString(), h.beginPath(), h.moveTo(r, l), h.lineTo(o, d), h.lineTo(s, u), h.closePath(), h.fill()
                ...
                i.elements.arc = {
                    ...
                    inLabelRange: function (t) {
                        ...
                        if (i) {
                            ...
                            for (; r > l;)r -= 2 * Math.PI;
                            for (; s > r;)r += 2 * Math.PI;
                            var d = r >= s && l >= r, u = o >= i.innerRadius && o <= i.outerRadius;
                            return d && u
                        }
                        return !1
                    }, tooltipPosition: function () {
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.elements.line = {
                    ...
                    lineToNextPoint: function (t, e, n, i, a) {
                        ...
                        r.save(),
                        i._children.length > 0 && a.fill && (r.beginPath(), e.each(i._children, function (t, n) {
            ...
            e.exports = function (t) {
                ...
                n.elements.point = {
                    ...
                    inRange: function (t, e) {
                        ...
                        var t, a, r, o, s, l, d = this._view, u = this._chart.ctx, c = d.pointStyle, h = d.radius, f = d.x, g = d.y;
                        if (!d.skip) {
                            ...
                            if (!(isNaN(h) || 0 >= h)) {
                                switch (u.strokeStyle = d.borderColor || i, u.lineWidth = e.getValueOrDefault(d.borderWidth, n.elements.point.borderWidth), u.fillStyle = d.backgroundColor || i, c) {
                                    default:
                                        ...
                                        break;
                                    case"triangle":
                                        u.beginPath(), a = 3 * h / Math.sqrt(3), s = a * Math.sqrt(3) / 2, u.moveTo(f - a / 2, g + s / 3), u.lineTo(f + a / 2, g + s / 3), u.lineTo(f, g - 2 * s / 3), u.closePath(), u.fill();
                                        break;
                                    case"rect":
                                        l = 1 / Math.SQRT2 * h, u.fillRect(f - l, g - l, 2 * l, 2 * l), u.strokeRect(f - l, g - l, 2 * l, 2 * l);
                                        break;
                                    case"rectRot":
                                        l = 1 / Math.SQRT2 * h, u.beginPath(), u.moveTo(f - l, g), u.lineTo(f, g + l), u.lineTo(f + l, g), u.lineTo(f, g - l), u.closePath(), u.fill();
                                        break;
                                    case"cross":
                                        u.beginPath(), u.moveTo(f, g + h), u.lineTo(f, g - h), u.moveTo(f - h, g), u.lineTo(f + h, g), u.closePath();
                                        break;
                                    case"crossRot":
                                        u.beginPath(), r = Math.cos(Math.PI / 4) * h, o = Math.sin(Math.PI / 4) * h, u.moveTo(f - r, g - o), u.lineTo(f + r, g + o), u.moveTo(f - r, g + o), u.lineTo(f + r, g - o), u.closePath();
                                        break;
                                    case"star":
                                        u.beginPath(), u.moveTo(f, g + h), u.lineTo(f, g - h), u.moveTo(f - h, g), u.lineTo(f + h, g), r = Math.cos(Math.PI / 4) * h, o = Math.sin(Math.PI / 4) * h, u.moveTo(f - r, g - o), u.lineTo(f + r, g + o), u.moveTo(f - r, g + o), u.lineTo(f + r, g - o), u.closePath();
                                        break;
                                    case"line":
            ...
            e.exports = function (t) {
                ...
                e.elements.rectangle = {
                    ...
                    draw: function () {
                        ...
                        n.borderWidth && (a += s, r -= s, o += s), e.beginPath(), e.fillStyle = n.backgroundColor, e.strokeStyle = n.borderColor, e.lineWidth = n.borderWidth;
                        var l = [[a, n.base], [a, o], [r, o], [r, n.base]], d = ["bottom", "left", "top", "right"], u = d.indexOf(n.borderSkipped, 0);
                        -1 === u && (u = 0), e.moveTo.apply(e, t(0));
                        for (var c = 1; 4 > c; c++)e.lineTo.apply(e, t(c));
                        e.fill(), n.borderWidth && e.stroke()
                    }, height: function () {
            ...
            e.exports = function (t) {
                var e = t.helpers, n = {position: "bottom"}, i = t.Scale.extend({
                    determineDataLimits: function () {
                        ...
                        var d = a.height - (a.paddingTop + a.paddingBottom), u = d / r, c = u * (e - a.minIndex) + a.paddingTop;
                        return a.options.gridLines.offsetGridLines && i && (c += u / 2), a.top + Math.round(c)
                    }, getPixelForTick: function (t, e) {
            ...
            e.exports = function (t) {
                var e = t.helpers, n = {
                    ...
                    determineDataLimits: function () {
                        ...
                        var a, r, o = this, s = o.paddingLeft, l = o.paddingBottom, d = o.start, u = +o.getRightValue(t), c = o.end - d;
                        return o.isHorizontal() ? (r = o.width - (s + o.paddingRight), a = o.left + r / c * (u - d), Math.round(a + s)) : (r = o.height - (o.paddingTop + l), a = o.bottom - l - r / c * (u - d), Math.round(a))
                    }, getValueForPixel: function (t) {
            ...
            e.exports = function (t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    handleTickRangeOptions: function () {
                        ...
                        h = e.almostEquals(h, Math.round(h), s / 1e3) ? Math.round(h) : Math.ceil(h), r.push(void 0 !== i.min ? i.min : u);
                        for (var f = 1; h > f; ++f)r.push(u + f * s);
            ...
            e.exports = function (t) {
                var e = t.helpers, n = {
                    ...
                    determineDataLimits: function () {
                        ...
                        var n = this, i = n.options, a = i.ticks, r = n.chart, o = r.data, s = o.datasets, l = e.getValueOrDefault, d = n.isHorizontal();
                        if (n.min = null, n.max = null, i.stacked) {
                            var u = {};
                            e.each(s, function (a, o) {
                                ...
                                r.isDatasetVisible(o) && t(s) && (void 0 === u[s.type] && (u[s.type] = []), e.each(a.data, function (t, e) {
                                    var a = u[s.type], r = +n.getRightValue(t);
                        ...
                        var r, o, s = this, l = s.start, d = +s.getRightValue(t), u = e.log10(s.end) - e.log10(l), c = s.paddingTop, h = s.paddingBottom, f = s.paddingLeft;
                        return s.isHorizontal() ? 0 === d ? o = s.left + f : (r = s.width - (f + s.paddingRight), o = s.left + r / u * (e.log10(d) - e.log10(l)), o += f) : 0 === d ? o = s.top + c : (r = s.height - (c + h), o = s.bottom - h - r / u * (e.log10(d) - e.log10(l))), o
                    }, getValueForPixel: function (t) {
            ...
            e.exports = function (t) {
                var e = t.helpers, n = t.defaults.global, i = {
                    ...
                    getValueCount: function () {
                        ...
                        var t, i, a, r, o, s, l, d, u, c, h, f, g = this.options.pointLabels, p = e.getValueOrDefault(g.fontSize, n.defaultFontSize), m = e.getValueOrDefault(g.fontStyle, n.defaultFontStyle), v = e.getValueOrDefault(g.fontFamily, n.defaultFontFamily), b = e.fontString(p, m, v), y = e.min([this.height / 2 - p - 5, this.width / 2]), x = this.width, k = 0;
                        ...
                        if (i.display) {
                            var d = t.ctx, u = l(r.fontSize, n.defaultFontSize), c = l(r.fontStyle, n.defaultFontStyle), h = l(r.fontFamily, n.defaultFontFamily), f = e.fontString(u, c, h);
                            if (e.each(t.ticks, function (o, s) {
                                ...
                                for (var g = t.getDistanceFromCenterForValue(i.reverse ? t.min : t.max), p = l(s.fontSize, n.defaultFontSize), m = l(s.fontStyle, n.defaultFontStyle), v = l(s.fontFamily, n.defaultFontFamily), b = e.fontString(p, m, v), y = t.getValueCount() - 1; y >= 0; y--) {
                                    ...
                                    d.font = b, d.fillStyle = _;
                                    var w = t.pointLabels, S = w.length, M = w.length / 2, D = M / 2, C = D > y || y > S - D, T = y === D || y === S - D;
                                    0 === y ? d.textAlign = "center" : y === M ? d.textAlign = "center" : M > y ? d.textAlign = "left" : d.textAlign = "right", T ? d.textBaseline = "middle" : C ? d.textBaseline = "bottom" : d.textBaseline = "top", d.fillText(w[y] ? w[y] : "", k.x, k.y)
                                }
                            }
                        }
                    }
                ...
                var e = t.helpers, n = {
                    ...
                    initialize: function () {
                        ...
                        if (a.ctx.font = l, a.ticks = [], a.unitScale = 1, a.scaleSizeInUnits = 0, a.options.time.unit)a.tickUnit = a.options.time.unit || "day", a.displayFormat = a.options.time.displayFormats[a.tickUnit], a.scaleSizeInUnits = a.lastTick.diff(a.firstTick, a.tickUnit, !0), a.unitScale = e.getValueOrDefault(a.options.time.unitStepSize, 1); else {
                            var d = a.isHorizontal() ? a.width - (a.paddingLeft + a.paddingRight) : a.height - (a.paddingTop + a.paddingBottom), u = a.tickFormatFunction(a.firstTick, 0, []), c = a.ctx.measureText(u).width, h = Math.cos(e.toRadians(a.options.ticks.maxRotation)), f = Math.sin(e.toRadians(a.options.ticks.maxRotation));
                            c = c * h + r * f;
                            var g = d / c;
                        ...
                        if (r) {
                            ...
                            if (a.isHorizontal()) {
                                var l = a.width - (a.paddingLeft + a.paddingRight), d = (l / Math.max(a.ticks.length - 1, 1), l * s + a.paddingLeft);
                                return a.left + Math.round(d)
                            }
                            var u = a.height - (a.paddingTop + a.paddingBottom), c = (u / Math.max(a.ticks.length - 1, 1), u * s + a.paddingTop);
